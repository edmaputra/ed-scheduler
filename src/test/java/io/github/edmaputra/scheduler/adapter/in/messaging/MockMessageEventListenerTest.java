...
class MockMessageEventListenerTest {

  @Mock
  private JobScheduleEventUseCase jobScheduleEventUseCase;

  private MockMessageEventListener listener;

  @BeforeEach
  void setUp() {
    listener = new MockMessageEventListener(jobScheduleEventUseCase);
  }

  @Test
  void shouldDelegateToUseCaseWithSameContractMethod() {
    JobScheduleEvent event = JobScheduleEvent.builder()
      .eventId("evt-mock-test")
