 ...
 * <p>
 * To use this: 1. Add Kafka dependency to build.gradle: implementation
 * 'org.springframework.kafka:spring-kafka'
 * <p>
 * 2. Configure Kafka in application.properties: spring.kafka.bootstrap-servers=localhost:9092
