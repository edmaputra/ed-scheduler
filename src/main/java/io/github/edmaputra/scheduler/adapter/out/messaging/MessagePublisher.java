 ...
 * <p>
 * Implementations can use various message providers: - Kafka: KafkaTemplate - RabbitMQ:
 * RabbitTemplate - AWS SQS: SqsTemplate - Google Pub/Sub: PubSubTemplate - Azure Service Bus:
 * ServiceBusTemplate
 */
